    ...
    *Analyzing pre-test to post-test measurements for clinical decision making*
    ...
    with col1:
        ...
        <div class="insight-card">
            ...
            <p>Maitland group showed <span class="highlight">50% greater response rate</span> in pain reduction (VAS)</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="insight-card">
            ...
            <p><span class="highlight">33% better</span> disability improvement with Maitland approach</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        st.markdown("""
        <div class="insight-card">
            <h4>3. Treatment Duration</h4>
            <p>Optimal results seen with <span class="highlight">10+ weeks</span> of treatment</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    for metric in metrics:
        ...
        summary_data.append({
            ...
            'Difference': maitland_change - conv_change,
    ...
    def color_diff(val):
        ...
        if (direction == 'increase' and val > 0) or (direction == 'decrease' and val < 0):
            return 'color: green'
        else:
            return 'color: red'
    ...
    with col2:
        ...
        st.metric(
            ...
            value=f"{maitland_change - conv_change:.1f} {metrics[selected_metric]['unit']}",
            delta=f"Maitland shows {'better' if (metrics[selected_metric]['direction'] == 'increase' and (maitland_change - conv_change) > 0 or (metrics[selected_metric]['direction'] == 'decrease' and (maitland_change - conv_change) < 0) else 'worse'} improvement",
            delta_color="normal"
        )
...
if page != "🏠 Overview":
    ...
    with col1:
        ...
        <div class="insight-card">
            <h4>1. Pain Reduction</h4>
            <p>Maitland group showed <span class="highlight">{vas_diff:.1f} points greater</span> reduction in pain (VAS)</p>
        </div>
        """, unsafe_allow_html=True)
